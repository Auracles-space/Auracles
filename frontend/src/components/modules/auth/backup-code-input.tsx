  ...
  return (
    <label className="block" htmlFor="backup-code">
      ...
      <input
        ...
        className="mt-2 min-h-12 w-full rounded-control border border-border-strong bg-surface-2 px-4 py-2 text-sm text-foreground outline-none focus:outline-none focus-visible:outline-none transition-colors placeholder:text-foreground-subtle focus:border-accent focus:ring-1 focus:ring-accent focus-visible:border-accent focus-visible:ring-1 focus-visible:ring-accent"
        id="backup-code"
