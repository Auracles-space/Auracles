  ...
  return (
    <label className="block" htmlFor="totp-code">
      ...
      <input
        ...
        className="mt-2 min-h-11 w-full rounded-control border border-border-strong bg-surface-3 px-3 py-2 text-center font-heading text-lg font-semibold tracking-[0.05em] text-foreground outline-none transition placeholder:text-foreground-subtle focus:border-brand focus:ring-2 focus:ring-brand/15"
        id="totp-code"
        inputMode="numeric"
        maxLength={6}
        onChange={(event) => {
