...
export type DeactivateAccountV1SettingsAccountDeactivatePostData = {
    body: AccountDeactivateRequest;
};

export type DeactivateAccountV1SettingsAccountDeactivatePostResponse = (RegisterResponse);

export type DeactivateAccountV1SettingsAccountDeactivatePostError = (HTTPValidationError);
