...
const compatibilityAliases = {
  ...
  listSharedPayoutDestinations:
    "listSharedPayoutDestinationsV1AdminPayoutDestinationsSharedGet",
  setPayoutDestinationAllowance:
    "setPayoutDestinationAllowanceV1AdminPayoutDestinationsAllowancePost",
  ...
  suspendOrgContributorCapability: "adminSuspendContributorCapabilityV1AdminOrgsOrgIdContributorCapabilitySuspendPost",
  reinstateOrgContributorCapability: "adminReinstateContributorCapabilityV1AdminOrgsOrgIdContributorCapabilityReinstatePost",
  revokeOrgContributorCapability: "adminRevokeContributorCapabilityV1AdminOrgsOrgIdContributorCapabilityRevokePost",
  suspendOrgOperatorCapability: "adminSuspendOperatorCapabilityV1AdminOrgsOrgIdOperatorCapabilitySuspendPost",
  reinstateOrgOperatorCapability: "adminReinstateOperatorCapabilityV1AdminOrgsOrgIdOperatorCapabilityReinstatePost",
  revokeOrgOperatorCapability: "adminRevokeOperatorCapabilityV1AdminOrgsOrgIdOperatorCapabilityRevokePost",
